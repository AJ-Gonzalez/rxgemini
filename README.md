...
| LOG_MODE       | (Not yet implemented) Switch between output modes: `pretty`: uses colorful and detailed messages, `python`: uses the python logger, `quiet` shows no output unless necessary to prompt ot inform the user | String | `LOG_MODE: "pretty"`|
